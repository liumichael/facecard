...
The one major change to our processes is our move from directly committing our code to the master branch to committing code to our own separate branch and only do pull requests when a certain feature is implemented and made sure it does not break the codebase.
...
* For this deliverable, Zhen is responsible for implementing a basic implementation of the cue card feature for the product. He is also responsible for writing the script for the video along with Chris.
